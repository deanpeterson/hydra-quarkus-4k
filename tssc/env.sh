...
export IMAGE_URL=${IMAGE_URL-quay-quay-quay-test.apps.salamander.aimlworkbench.com/deanpeterson/hydra-quarkus-4k:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/deanpeterson/hydra-quarkus-4k-gitops
